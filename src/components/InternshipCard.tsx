...
const InternshipCard = () => {
  const openMail = () => {
    window.open('mailto:shivambhushanedu@gmail.com', '_blank');
  };
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">Preferably Gurugram</p>
          </div>
        </div>
      ...
      <div className="mt-10">
        ...
        <p className="text-foreground text-sm">
          ...
          Blending AI passion with hands-on development to bring tech ideas to
          life. <br />I ship fast, and love building useful things that actually
          work.
        </p>
      </div>
